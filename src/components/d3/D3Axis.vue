<template>
  <g class="scale-ticks" :class="[position]">
    <!-- Tick instance -->
    <g v-for="(item, index) in ticks" :key="index" :transform="item.transform">
      <!-- Tick Line -->
      <line v-bind="item.lineTransform" stroke="#333" stroke-width="2" />
